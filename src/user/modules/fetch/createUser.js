...
export function initCreateUserForm() {
    ...
    form.addEventListener("submit", async function (event) {
        ...
        const camposObligatorios = [
            { id: 'cname', nombre: 'Número de usuario' },
        ...
        const result = await mostrarConfirmacionGuardado({
            title: '¿Crear usuario?',
            message: `¿Estás seguro de crear el usuario ${formData.nombre} ${formData.apellidos} con número ${numeroUsuario}?`,
        ...
        if (result.confirmed) {
            ...
            try {
                // Simular progreso mientras se crea el usuario
                ...
                if (response.ok) {
                    ...
                    // Esperar un poco antes de redirigir para que se vea el éxito
                    setTimeout(() => {
                    ...
                    if (response.status === 400) {
                        ...
                        errorMessage = "Ya existe un usuario con ese número o correo electrónico.";
